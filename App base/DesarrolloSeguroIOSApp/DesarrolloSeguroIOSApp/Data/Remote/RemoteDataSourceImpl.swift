...
final class RemoteDataSourceImpl: RemoteDataSourceProtocol {
    ...
    func transformations(heroID: String) async throws -> [Transformation]? {
        // Obtenemos la request
        guard let URLRequest = urlRequestHelper.transformations(heroID: heroID) else {
            print("Error while creating the URLRequest for the transformations")
            return nil
        }
        ...
        case 200:
            ...
            print("Transformations successfully fetched from server: \(transformations)")
